...
namespace Hrinnova_FormsProject.Controllers
{
    public class EditController : Controller
    {
...

        {
            ...
            eim.employeedetails = from employee_details in entity.employee_details.Take(100) select employee_details;
        ...
        public ActionResult Edit(int id)
        {
            ...
            model.prevemploy1 = entity.prev_employ_1.FirstOrDefault(pe1 => pe1.employee_id == id);
            model.prevemploy2 = entity.prev_employ_2.FirstOrDefault(pe2 => pe2.employee_id == id);
            model.prevemploy3 = entity.prev_employ_3.FirstOrDefault(pe3 => pe3.employee_id == id);
            model.prevemploy4 = entity.prev_employ_4.FirstOrDefault(pe4 => pe4.employee_id == id);
            model.prevemploy5 = entity.prev_employ_5.FirstOrDefault(pe5 => pe5.employee_id == id);
