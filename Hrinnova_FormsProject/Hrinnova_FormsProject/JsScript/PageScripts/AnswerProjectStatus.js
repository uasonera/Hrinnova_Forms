...
function pageLoad() {
    ...
    var Template = "<div id='dvQuestionAnswerBlock{ID}' class='question-answer-block' > "
                ...
                + "</div>"
                + "<br/>"
                + "<div id='dvAnswerBlock' class='answer-block EnableAnswerAnswerBlock'> "
                + " <textarea id='txtAnswer' maxlength='500' class='textarea ' cols='20' rows='2'>{AnswerText}</textarea> "
                + " </div> "
                + "<br/>"
                + " <div id='dvSubmitAnswer' class='submit-answer ' > "
...
//        var ProjectStatusZone = $("#ddlProjectStatusZone");
...
//            ToogleActiveState(true, SubmitReport);
//            ToogleActiveState(true, ProjectStatusZone);
    ...
    function GetActiveProject() {
        ...
        $.ajax({
            type: "POST",
            url: "../Admin/AnswerProjectStatus.aspx/GetActiveProject",
            data: "{}",
    ...
    function GetProjectStatusZone() {
        ...
        $.ajax({
            type: "POST",
            url: "../Admin/AnswerProjectStatus.aspx/GetProjectStatusZone",
            data: "{}",
            contentType: 'application/json; charset=utf-8',
            datatype: 'json',
            success: function (jsonresult) {
    ...
    function GetQuestionsByProjectID(projectID) {
        ...
        $.ajax({
            type: "POST",
            url: "../Admin/AnswerProjectStatus.aspx/GetProjectStatusQuestionAnswer",
    ...
    $(document).on("click", "#SubmitAnswer", function (event) {
        ...
        $.ajax({
            type: "POST",
            url: "../Admin/AnswerProjectStatus.aspx/SubmitNewAnswer",
    ...
    $(document).on("click", "#SubmitReport", function (event) {
        ...
        alert(ProjectStatusReport.ProjectName);
        ...
        $.ajax({
            type: "POST",
            url: "../Admin/AnswerProjectStatus.aspx/SubmitReport",
            data: DTO,
            contentType: 'application/json; charset=utf-8',
            datatype: 'json',
            success: function (jsonresult) {
    ...
    $(document).on("click", "#ApproveReport", function (event) {
        ...
        $.ajax({
            type: "POST",
            url: "../Admin/AnswerProjectStatus.aspx/ApproveReport",
            data: DTO,
            contentType: 'application/json; charset=utf-8',
            datatype: 'json',
            success: function (jsonresult) {
