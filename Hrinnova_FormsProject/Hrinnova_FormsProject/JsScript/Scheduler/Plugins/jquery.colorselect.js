...
(function($) {
    ...
    $.fn.colorselect = function(option) {        
        ...
        var blanka = '<a href="#" id="{1}-{0}" key="{2}" hidefocus="on"><em><span style=" text-align:center; width:10px;padding-top:2px; height:10px;border:solid 1px #8B7B8B;" unselectable="on"></span></em></a>'
        var blank = [];
        blank.push("ffffff");
        blank.push(id);
        blank.push(-1);
