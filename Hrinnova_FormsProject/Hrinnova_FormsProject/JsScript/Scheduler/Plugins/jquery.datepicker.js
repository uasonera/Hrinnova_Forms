; (function($) {
    ...
    $.fn.datepicker = function(o) {
        ...
        if (cp.length == 0) {
            var cpHA = [];
            cpHA.push("<div id='BBIT_DP_CONTAINER' class='bbit-dp' style='width:186px;z-index:999;'>");
            if ($.browser.msie6) {
            ...
            cpHA.push("<td colspan='4'><button id='BBIT-DP-MP-OKBTN' class='bbit-dp-mp-ok primary-btn'>", def.btnOk, "</button><button id='BBIT-DP-MP-CANCELBTN' class='bbit-dp-mp-cancel secondary-btn'>", def.btnCancel, "</button></td>");
            cpHA.push("</tr>");
