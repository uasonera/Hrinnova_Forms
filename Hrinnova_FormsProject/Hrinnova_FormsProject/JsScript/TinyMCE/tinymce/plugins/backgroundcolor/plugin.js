...
tinymce.PluginManager.add('backgroundcolor', function (editor) {
    function mapColors() {
    ...
    function onPanelClick(e) {
        ...
        if ((value = e.target.getAttribute('data-mce-color'))) {
            ...
            if (value) {
                ...
                if (node.nodeName == 'TABLE' || node.nodeName == 'TD') {
    ...
    function onButtonClick() {
        ...
        if (self._color) {
            ...
            if (node.nodeName == 'TABLE' || node.nodeName == 'TD') {
                tinyMCE.DOM.setStyle(node, 'background-color', self._color);
            }
        }
    }

    editor.addButton('bgcolor',
    {
        type: 'colorbutton',
        tooltip: 'Table Background color',
        popoverAlign: 'bc-tl',
        selectcmd: 'background-color',
        panel: {
