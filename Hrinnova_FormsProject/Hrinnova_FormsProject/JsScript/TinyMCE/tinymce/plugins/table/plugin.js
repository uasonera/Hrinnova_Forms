    ...
    */
    ...
    function Plugin(editor) {
        ...
        function tableDialog() {
            ...
            //            var borderStyleContent = removePxSuffix(dom.getStyle(tableElm, 'border') || dom.getAttrib(tableElm, 'border'));

            //            var borderWidth = borderStyleContent.split(' ')[0];

            //            var borderStyle = borderStyleContent.split(' ')[1];

            //            var borderColor = borderStyleContent.split(' ')[2];
            ...
            data = {
                ...
                //border: dom.getAttrib(tableElm, 'border').split(' ')[0], // Code Added By Advait Baxi : 04-Oct-2013
                //border: borderWidth, // Code Added By Advait Baxi : 04-Oct-2013
            ...
            // ------------- Code Added By Advait Baxi : 04-Oct-2013 - Start ------------------

            //            if (dom.getAttrib(tableElm, 'border').split(' ')[1] != 'undefine') {
            //                data.style = dom.getAttrib(tableElm, 'border').split(' ')[1];
            //            }

            //            if (borderStyle != 'undefine') {
            //                data.style = borderStyle;
            //            }

            // ------------- Code Added By Advait Baxi : 04-Oct-2013 - End -------------------
            ...
            editor.windowManager.open({
                ...
                onsubmit: function () {
                    ...
                    editor.undoManager.transact(function () {
                        ...
                        //                        editor.dom.setStyles(tableElm, {
                        //                            border: addSizeSuffix(data.border) + ' ' + data.style + ' ' + data.bordercolor
                        //                        });
        ...
        // -------------- Added by Advait Baxi : 04-Oct-2013 - Start  ------------------------
        editor.addMenuItem('tablecolor', {
				    ...
				    onclick: function (e) {
				        ...
				        if (node.nodeName == 'TABLE') {
				            if ((e.target.getAttribute('data-mce-color'))) {
				                ...
				                var value = '#' + e.target.getAttribute('data-mce-color');

				                if (value) {

				                    var el = editor.selection.getStart();
				                    var tdElm = editor.dom.getParent(el, "td,th");
				                    var trElm = editor.dom.getParent(el, "tr");
				                    var tableElm = editor.dom.getParent(el, "table");

				                    tinyMCE.DOM.setStyle(node, 'background-color', value);
				                }
				            }
				        }
        ...
        editor.addMenuItem('row', {
            ...
            menu: [
                ...
                { text: '-' },
                { text: "Row Color", menu: [{ // Row color added by Advait Baxi : 08-Oct-2013
                    type: 'container',
                    html: renderColorPicker(),
                            ...
                            if (value) {
                                ...
                                editor.undoManager.transact(function () {
                                    ...
                                    each(rows, function (rowElm) {
                                        ...
                                        tinyMCE.DOM.setStyle(rowElm, 'background-color', value);
                                    });
        ...
        var menuItems = [];
        each("inserttable tablecolor tableprops deletetable | cell row column".split(' '), function (name) {
            if (name == '|') {
                menuItems.push({ text: '-' });
            } else {
