...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        if(System.IO.Directory.Exists(Server.MapPath("~/userfiles1/"))==false)            
        {
            System.IO.Directory.CreateDirectory(Server.MapPath("~/userfiles1/"));
        }
        UserFilesAbsolutePath = Server.MapPath("~/userfiles1/");
